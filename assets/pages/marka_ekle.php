<div id="markaekle" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="modal fade bd-example-modal-lg rounded" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    <form class="form" enctype="multipart/form-data" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="navimarka" placeholder="Marka İsmini Girin" required>
                                        </div>
                                </div>
                                <div class="col-md-3"></div>
                            </div>
