...
<body>
    ...
    include("assets/pages/add.php"); //veri ekleme işlemleri
    include("assets/pages/add_brands.php"); //marka ekleme sayfası
    include("assets/pages/add_cars.php"); //araba markası ekleme sayfası
    include("assets/pages/add_product.php"); //cihaz ekleme sayfası
    ?>
    <!-- İçe Aktarmalar-->
                        ...
                        <form class="form" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="row m-4">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    <p class="mt-2">
                                        <input name="stok" type="text" class="form-control text-center" value="<?php echo $veri['product_compatible_car'] ?>"placeholder="   <?php echo $veri['product_stock'] . " Adet"; ?>">
...
<input class="btn btn-success rounded" type="submit" value="KAYDET">
                                                        ...
                                                        <a href="/navisit/home.php" class=" ml-3 btn btn-info rounded float-right">Geri</a>
